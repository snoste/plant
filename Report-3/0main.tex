...
\begin{document}
\title{Design and development of plan monitoring system using a wireless sensor network}
...
\include{3hardw-setup}

\include{4protocal}

\include{5netw-arch-options}
\include{6method-impl}

\include{7development}

\include{8hardw-softw-plan}
\include{9conclusion}
\endgroup
...
section{Conclusion}
d in this paper will be develop in  next two month creating a real prototype.
